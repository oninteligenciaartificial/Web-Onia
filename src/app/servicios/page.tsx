            ...
            <RevealOnScroll key={s.id} delay={1}>
              <div id={s.id} className={`grid lg:grid-cols-2 gap-12 items-center ${s.reverse ? 'lg:direction-rtl' : ''}`}>
                ...
                <div className={s.reverse ? 'lg:order-1' : ''}>
                  ...
                  <a
                    href={`https://wa.me/59175470140?text=${encodeURIComponent(`Hola OnIA! Me interesa el servicio: ${s.title}. Me gustaría recibir más información y un presupuesto.`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl text-sm font-semibold gradient-primary text-accent-dark hover:shadow-lg hover:shadow-primary/25 transition-all duration-300 hover:scale-[1.02]"
                  >
          ...
          <RevealOnScroll>
            <div className="grid lg:grid-cols-2 gap-12 items-center opacity-50 pointer-events-none">
              ...
              <div className="lg:order-1">
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-4xl font-black text-on-surface-variant/10">05</span>
